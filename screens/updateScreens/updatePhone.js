...
<Text style={styles.texticon}>Changer votre numéro de téléphone:</Text>
...
<Modal
             ...
             >
              ...
              <View style={{borderRadius:10,backgroundColor:"#ffffff",marginBottom:hp('50%'),marginTop:hp('20%'),marginHorizontal:wp('10%'),padding:40,flex:1}} >
                 ...
                 <Text>Modifier votre numéro de téléphone:</Text>
                 <View style={styles.modalTextView}>
                 <TextInput style={styles.input} keyboardType="numeric" onChangeText={(text)=>setPhone(text)}  />
                 </View>
