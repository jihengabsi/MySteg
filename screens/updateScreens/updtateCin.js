...
const updateE = ({navigation,route}) => {
  ...
  const {cin,email,password,name,phone,adress,picture} = route.params
  const [modal,setModal] = useState(false)
  const [cin1,setCin] = useState("")
...
<Text style={styles.texticon}>Changer votre cin:</Text>
...
<Modal
             ...
             >
              ...
              <View style={{borderRadius:10,backgroundColor:"#ffffff",marginBottom:hp('50%'),marginTop:hp('20%'),marginHorizontal:wp('10%'),padding:40,flex:1}} >
                 ...
                 <Text>Modifier votre cin:</Text>
                 <View style={styles.modalTextView}>
                 <TextInput style={styles.input} keyboardType="numeric" onChangeText={(text)=>setCin(text)}  />
                 </View>
