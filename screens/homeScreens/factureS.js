...
const Home = ({navigation})=>{
    ...
    const renderList = ((item)=>{
          return(
            ...
            <Card style={styles.mycard} onPress={()=>navigation.navigate("fs1",{item})}>
            ...
            <Text style={{ fontSize: 18, color: 'black' }}>{strings.simdacConselect}</Text>   
                 ...
                 <View style={{ paddingHorizontal: 8, paddingVertical: 16,flexDirection:"column",  }}>
                    ...
                    <Text style={{ fontSize: 18, color: 'gray' }}>{item.consoElec}</Text>   
                    <Text style={{ fontSize: 18, color: 'gray' }}>{item.consoGaz}</Text>
                    <Text style={{ fontSize: 18, color: 'gray' }}>{item.montant}</Text>
